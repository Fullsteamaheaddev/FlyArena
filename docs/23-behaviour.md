...
| Food odour (vinegar/banana) | In the plume, walk longer and drop random saccades. Rising concentration: surge (walk straight; turn toward upwind if there is wind). Falling: one casting saccade, toward the stronger antenna if the sides differ. Fruit Fly (`hungryForage`): start hungry, skip grooming and voluntary takeoff, easier surge, steer into the inward wind whenever in the plume, tropotaxis toward the stronger antenna; not visual homing | van Breugel & Dickinson 2014 |
