...
- WebGPU brains use bounded bursts (at most eight simulated milliseconds / eight CPU milliseconds;
  odor race uses 16 / 16), flush, and await their submitted GPU work before scheduling more. This
